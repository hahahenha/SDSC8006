...
def start_new_run(run):
    ...
    if platform.system() == 'Windows':
        ...
        os.system("python \"%SUMO_HOME%/tools/randomTrips.py\" -n data/txmap.net.xml --trip-attributes=\"type=\\\"light_norm_heavy\\\"\" "
            "-a data/txmap.add.xml -r data/txmap.rou.xml -e 12000 -p 0.75 --binomial=5 -L")
        # Delete unwanted alt route file
        os.system("del \"data/txmap.rou.alt.xml\"")
        ...
        os.system("python \"$SUMO_HOME/tools/randomTrips.py\" -n data/txmap.net.xml --trip-attributes=\"type=\\\"light_norm_heavy\\\"\" "
            "-a data/txmap.add.xml -r data/txmap.rou.xml -e 12000 -p 0.75 --binomial=5 -L")
        # Delete unwanted alt route file
        os.system("rm \"data/txmap.rou.alt.xml\"")
        # Delete unwanted trips file
        os.system("rm trips.trips.xml")

    # Start SUMO and connect traCI to it
    traci.start([sumoBinary, "-c", "data/txmap.sumocfg", "--gui-settings-file", "data/guisettings.xml",
